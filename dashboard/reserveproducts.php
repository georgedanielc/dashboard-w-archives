...
<?php include ('reservationauto.php'); ?>
<head>
    <meta charset="utf-8">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li  class="active"><a href="reserveproducts.php"><i class="fa fa-globe"></i> Reservations</a></li>
...
<ul class="nav navbar-nav navbar-right navbar-user">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Rifa Motor Shop <small>Reservations</small></h1>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								  ...
								  <a href="addreservationadmin.php"><button type="button" class="btn btn-primary">Add Reservation</button></a>
								  
								  </div>
								  
								  
								      <div class="button-print">
									    <a href="reports/reservereport.php" target="_blank">
								  <button type="button" class="btn btn-success">Print Reseserved</button>
								  </a>
								  </div>
...
<table>
  ...
  <?php
    ...
    $txtsearch=$_POST['txtsearch-btn'];
								$result= mysqli_query($conn,"select * from reservation where barcode_id LIKE '%$txtsearch%' or name LIKE '%$txtsearch%' order by datereserved ASC ") or die (mysql_error());
	
	}
	else{
		
									$result= mysqli_query($conn,"select * from reservation order by datereserved ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	         <a href="deletereserve.php<?php echo '?Barcode='.$barcode."&".'name='.$name; ?>"><button type="button" class="btn btn-primary btn-sm">Cancel</button></a>
			 <a href="transaction.php<?php echo '?Barcode='.$barcode."&".'name='.$name; ?>"><button type="button" class="btn btn-primary btn-sm">Complete</button></a>
	</td>
  </tr>
