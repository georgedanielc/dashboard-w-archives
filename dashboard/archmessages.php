        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Messages</a></li>
                ...
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted Messages</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Messages Information</h3>
                        </div>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archmessages where msg_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archmessages order by msg_id ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deletemessages.php<?php echo '?msg_id='.$msg_id; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actincident.php<?php echo '?msg_id='.$msg_id; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
