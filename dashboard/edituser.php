...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Edit User Information</small></h1>
                        ...
                        <div class="panel-body">
							...
							<div class="picture">
							   ...
							   <a href=""><?php if($row['uimage'] != ""): ?>
										<img src="userimage/<?php echo $row['uimage']; ?>" width="200px" height="150px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php else: ?>
							...
							<div class="products-add-info">
									...
									<label class="control-label .col-lg-2" for="first-name" >Contact Number:
							         ...
							         <input type="text" name="contact" class="form-control" placeholder="Enter Contact Number" value="<?php echo $row['contact']; ?>">
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name" >Email
									 ...
									 <div class="form-padding-correction">
							         <input name="email" class="form-control" placeholder="Enter Email" type="email" value="<?php echo $row['email']; ?>">
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name" >Password 
									 ...
									 <div class="form-padding-correction">
							         <input type="password" name="password" class="form-control" placeholder="Password" value="<?php echo $row['password']; ?>" disabled>
								    </div>
									</div>
...
mysqli_query($conn,"update users set contact='$contact',  email='$email',  uimage='$still_profile1' where username='$username'")or die(mysql_error());
...
mysqli_query($conn,"update users set  contact='$contact',  email='$email', username='$username', uimage='$still_profile1', 	image='$profile' where username='$username'")or die(mysql_error());								
echo "<script>alert('Successfully Updated Info!'); window.location='users.php'</script>";										
									}
