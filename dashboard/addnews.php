                        ...
                        <div class="panel-body">
							...
							<form method="POST" enctype="multipart/form-data" action="">
								  ...
								  <button type="Submit" class="btn btn-success">Add News</button>
									...
									<div class="btn-cancel">
									<button class="btn btn-success" type ="button" data-toggle="modal" data-target="#myModal">Add Later</button></div>
<!-- Modal -->
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                 <h4 class="modal-title" id="myModalLabel">Automatic Post</h4>

            </div>
            <div class="modal-body">
                <div class="col-md-12">
                    <div class="row">
                        <label for="idTourDateDetails">News And Announcement Post Date:</label>
                        <div class="form-group">
                            <div class="input-group">
                                <input type="date" name="autopost" class="form-control clsDatePicker"> <span class="input-group-addon"><i id="calIconTourDateDetails" class="fa fa-calendar"></i></span>
                ...
                <div class="modal-footer">
					 ...
					 <button type="Submit" class="btn btn-success">Add Later</button>
...
$autopost = $_POST['autopost'];
				...
				$autopost=strtotime(" 0000-00-00");
				$due_date= date("Y-m-d H:i:s",$autopost);
					
						$timezone = "Asia/Manila";
						if(function_exists('date_default_timezone_set')) date_default_timezone_set($timezone);
						$cur_date = date("Y-m-d H:i:s");
			if ($autopost == " "){
				$sql="insert into news (nname, info, nimage,author,autopost,post) values ('$nname','$info','$book_image','$username','$cur_date','Yes')";
						...
						mysqli_query($conn,"INSERT INTO audittrail(adminname,action,task,date)VALUES('$username','Added','News $nname','$cur_date')")or die(mysql_error());
                   
						$sql="insert into news (nname, info, nimage,author,autopost) values ('$nname','$info','$book_image','$username','$autopost')";
						if ($conn->query($sql) === TRUE) { 
                   		echo "<script>alert('News successfully added!'); window.location='news.php'</script>";
                        } else {
							echo "<script>alert('Banner sad!'); window.location='addbanner.php'</script>";
