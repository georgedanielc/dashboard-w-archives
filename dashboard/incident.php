                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Reported Incident</h3>
                        </div>
...
<div class="button-addproducts">
								  ...
								  <a href="addincident.php"><button type="button" class="btn btn-primary">Add Report </button></a>
...
<table  id="example">
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from incidentrpt where reportno LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from incidentrpt order by reportno ASC ") or die (mysql_error());
  ...
  <tbody id="myTable">
	...
	<td>
	 ...
	 <a href="archincidentss.php<?php echo '?reportno='.$reportno; ?><?php echo '?id_session='.$id_session; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>
