...
<table  id="example">
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
	...
	<td width="35%"><?php echo $row['itemdesc']; ?></td>
	<td><?php echo $row['requirements']; ?></td>
	<td><?php echo $row['quantity']; ?></td>

	<td>

	 <a href="deletereservables.php<?php echo '?item_id='.$item_id; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>
