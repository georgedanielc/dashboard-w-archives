...
<table  id="example">
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deletereservation.php<?php echo '?reservation_id='.$reservation_id; ?>"><button type="button" class="btn btn-primary btn-sm">Disapprove</button></a>
	 	 <a href="resapproval.php<?php echo '?reservation_id='.$reservation_id; ?>"><button type="button" class="btn btn-primary btn-sm">Approve</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
