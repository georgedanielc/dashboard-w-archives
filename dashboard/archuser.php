		   ...
		   <a class="navbar-brand" href="archives.php">Archives</a><?php } ?><?php else:?><?php endif;?>
            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="archuser.php"><i class="fa fa-bullseye"></i> Deleted Users</a></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Users</a></li>
                ...
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted Users</small></h1>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archuser where username LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archusers order by username ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deleteuser.php<?php echo '?username='.$username; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actuser.php<?php echo '?username='.$username; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
