...
$remarks = $_POST['remarks'];
		   ...
		   $result= mysqli_query($conn,"select * from document_request where request_id='$request_id'") or die (mysql_error());
			...
			$cur_date = date("Y-m-d H:i:s");
						...
						$sql="update document_request set username='$username',iname='$iname', stats = 'Disapprove'  , remarks = '$remarks' ,datedisapp='$cur_date' where request_id='$request_id'";
						mysqli_query($conn,"INSERT INTO audittrail(adminname,action,task,date)VALUES('$usernamer','Disapproved','Request ( $username $iname )','$cur_date')")or die(mysql_error());
						
						if ($conn->query($sql) === TRUE) { 
                   	echo "<script>alert('Request Rejected!'); window.location='request.php'</script>";
                        } else {
							echo "<script>alert('Banner sadzz!'); window.location='request.php'</script>";
                        }
