            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
                    <li><a href="archives.php"><i class="fa fa-database"></i> Archives</a></li>
					                    ...
					                    <li class="active"><a href="appres.php"><i class="fa fa-tasks"></i> Approved Reservation</a></li> 	
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
						  SORT BY:
														  <a href="sortdateres.php"><button type="button" class="btn btn-primary">DATE </button></a>
								  								  <a href="sortmonthress.php"><button type="button" class="btn btn-primary">MONTH </button></a>
																  <br><br>
...
<table>
  <tr>
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from reservation_request where request_id LIKE '%$txtsearch%' or cert_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
	else{
		
											$result= mysqli_query($conn,"SELECT * FROM reservation_request where stats='Approve' ORDER BY DATE(dateapp)=DATE(NOW()) DESC, DATE(dateapp)<DATE(NOW()) DESC, DATE(dateapp)>DATE(NOW()) ASC	  ") or die (mysql_error());
  ...
  <tr>
	...
	<td><?php echo $row['datereserved']; ?></td>
		<td><?php echo $row['dateapp']; ?></td>
	<td><?php echo $row['fname']; ?> <?php echo $row['mname']; ?> <?php echo $row['lname']; ?></td>

	<td>

	 <a href="deleterequest.php<?php echo '?reservation_id='.$reservation_id; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>
