...
<?php if($login=='SuperAdmin'):?>	
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from user where username LIKE '%$txtsearch%' or lname LIKE '%$txtsearch%'") or die (mysql_error());
											...
											$result= mysqli_query($conn,"select * from users WHERE NOT POSITION='Admin' AND NOT POSITION='SuperAdmin' AND NOT POSITION='Author' ") or die (mysql_error());
  ...
  <tbody  id="myTable">
    <td><a href="addadmin.php<?php echo '?resident_id='.$resident_id; ?>"><img src="resident/<?php echo $row['uimage']; ?>" width="75px" height="50px"></td>
