		   ...
		   ?><?php } ?><?php else:?>
					...
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						...
						<li><a href="bofficial.php"><i class="fa fa-globe"></i> Barangay Official</a></li>
												<li class="active"><a href="faqs.php"><i class="fa fa-globe"></i> FAQ's</a></li>
						<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                                         <h1>Barangay Mahabang Parang <small>Frequenlty Asked Questions</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Add FAQs</h3>
                        </div>
                        <div class="panel-body">
							...
							<form method="POST" enctype="multipart/form-data" action="">
									...
									<label class="control-label .col-lg-2" for="first-name">Question
                                    </label>
							         ...
							         <textarea 	 name="question" class="form-control"  placeholder="Enter Question" ></textarea>
																								     	...
																								     	<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Answer
                                    </label>
									 <div class="form-padding-correction">
						            ...
						            <div class="btn-addproducts">
									 <a href="faqs.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
									</div>
...
$answer = $_POST['answer'];
                    ...
                    $result=mysqli_query($conn,"select * from  faqs WHERE question='$question' ") or die (mySQL_error());
					$row=mysqli_num_rows($result);
					if ($row > 0)
					{
				    echo "<script>alert('Question Already active!'); window.location='addfaqs.php'</script>";
					...
					{		
						...
						if ($conn->query($sql) === TRUE) { 
                   		echo "<script>alert('Report successfully added!'); window.location='faqs.php'</script>";
                        } else {
							echo "<script>alert('News sad!'); window.location='addfaqs.php'</script>";
                        }
