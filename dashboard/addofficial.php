                        ...
                        <div class="panel-body">
							...
							<form method="POST" enctype="multipart/form-data" action="">
									...
									<label class="control-label .col-lg-2" for="first-name">Offical Name
							         ...
							         <input type="text" name="oname" class="form-control"  placeholder="Enter Name" required>
								    </div>
									</div>
																     	<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Birthdate
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="bdate" class="form-control"  placeholder="Enter Birthdate" required>
								    </div>
									</div>
...
$position = $_POST['position'];
                    ...
                    $result=mysqli_query($conn,"select * from bofficial WHERE oname='$oname' ") or die (mySQL_error());
					$row=mysqli_num_rows($result);
					if ($row > 0)
					{
					...
					{		
						...
						$sql="insert into bofficial (oname, bdate, address, position, oimage) values ('$oname','$bdate', '$address', '$position', '$book_image')";
						if ($conn->query($sql) === TRUE) { 
                   		echo "<script>alert('Offical successfully added!'); window.location='bofficial.php'</script>";
                        } else {
							echo "<script>alert('News sad!'); window.location='addoffical.php'</script>";
                        }
