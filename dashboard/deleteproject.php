                        ...
                        <div class="panel-body">
							...
							<div class="picture">
							   ...
							   <a href=""><?php if($row['pimage'] != ""): ?>
										<img src="banners/<?php echo $row['image']; ?>" width="200px" height="150px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php else: ?>
										<img src="images/book_image.jpg" width="100px" height="100px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php endif; ?>
										</a>	
                                    <input type="file" style="height:44px; margin-top:10px;" name="image" id="last-name2" value=<?php echo $row['image']; ?> disabled/>
							...
							<form method="POST" enctype="multipart/form-data" action="">
									...
									<div class="form-padding-correction">
							         <input type="text" name="pname" class="form-control"  placeholder="Enter Barcode" value="<?php echo $row['pname']; ?>" disabled>
								    </div>
									</div>
                                    </label>
																     	<div class="form-padding">
									...
									<div class="form-padding-correction">
							         <input type="text" name="info" class="form-control"  placeholder="Enter Barcode" value="<?php echo $row['info']; ?>" disabled>
								    </div>
									</div>
                                    </label>
																		<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Person Involved
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="person" class="form-control"  placeholder="Enter Person" value="<?php echo $row['person']; ?>"disabled>
								    </div>
									...
									<label class="control-label .col-lg-2" for="first-name">Date
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="date" class="form-control"  placeholder="Enter Date" value="<?php echo $row['date']; ?>"disabled>
								    </div>
									</div>
									 <?php } ?>
								 ...
								 <div class="btn-cancel">
								  <a href="deleteprojects.php<?php echo '?pname='.$pname;?>"> <button type="Submit" class="btn btn-success">Delete Project</button></a>
								 </div>
						         </form>
