                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div id="shieldui-grid1">
								  ...
								  <a href="residents.php"><button type="button" class="btn btn-primary">Add User </button></a>
...
<table  id="example">
  ...
  <tbody id="myTable">
    <td><img src="resident/<?php echo $row['uimage']; ?>" width="75px" height="50px"></td>
	...
	<td width="16%">
	 ...
	 <a href="archusers.php<?php echo '?username='.$username; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>
