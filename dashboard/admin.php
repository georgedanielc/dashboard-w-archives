                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div id="shieldui-grid1">
								  ...
								  <a href="srchadmin.php"><button type="button" class="btn btn-primary">Add Admin </button></a>
								  		 <?php else:?>
								<?php endif;?>
								  </div>
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from user where username LIKE '%$txtsearch%' or lname LIKE '%$txtsearch%'") or die (mysql_error());
											...
											$result= mysqli_query($conn,"select * from users where position='Admin' or position='Author' ") or die (mysql_error());
...
<td>
	...
	<a href="viewresidents.php<?php echo '?resident_id='.$resident_id; ?>"><button type="button" class="btn btn-primary btn-sm">View Information</button></a>
<?php if($login=='SuperAdmin'):?>
	 ...
	 <a href="edituser.php<?php echo  '?username='.$username;  ?>"><button type="button"  class="btn btn-primary btn-sm">Edit</button></a>
	 	 ...
	 	 <a href="archadmins.php<?php echo  '?username='.$username;  ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>
	 <?php else:?>
								<?php endif;?>
<?php } ?>
