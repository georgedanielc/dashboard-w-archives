...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div id="page-wrapper">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<div class="products-add-info">
									...
									<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Reservable
                                    </label>
									 <div class="form-padding-correction">
									...
									<label class="control-label .col-lg-2" for="first-name">Quantity
									 ...
									 <div class="form-padding-correction">
							         <textarea type="text" name="quantity" class="form-control"  placeholder="Enter Person" value=""disabled><?php echo $row['quantity']; ?></textarea>
								    </div>
									...
									<label class="control-label .col-lg-2" for="first-name">Date Reserved
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="datereserved" class="form-control"  id = "datepicker" placeholder="Enter Date" value="<?php echo $row['datereserved']; ?>"disabled>
								    </div>
									</div>
									<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Date Requested
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="datereq" class="form-control"  id = "datepicker" placeholder="Enter Date" value="<?php echo $row['datereq']; ?>"disabled>
								    </div>
									</div>
			...
			mysqli_query($conn,"update reservation_request set  stats = 'Approve' , dateapp = '$cur_dates' where reservation_id='$reservation_id'")or die(mysql_error());
			$sql="INSERT INTO audittrail(adminname,action,task,date)VALUES('$usernames','Approved','Reservation from $username ($iname)','$cur_date')";
			
			if (mysqli_query($conn, $sql)) {
           echo "<script>alert('Successfully Approved'); window.location='index.php'</script>";
            } else {
