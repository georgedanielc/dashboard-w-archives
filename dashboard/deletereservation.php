        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
		   ...
		   ?><?php } ?><?php else:?>
					...
					<?php
							...
							?>					
                    <li class="active"><a href="reservation.php"><i class="fa fa-tasks"></i> Pending Reservations&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $count; ?></span></a>  </li> 
					<?php
...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                                        <h1>Barangay Mahabang Parang <small>Reservation</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Disapprove Reservation</h3>
                        </div>
                        <div class="panel-body">
							...
							<div class="products-add-info">
									...
									<label class="control-label .col-lg-2" for="first-name">Document
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="iname" class="form-control"  placeholder="Enter Name" value="<?php echo $row['iname']; ?>" disabled>
								    </div>
									</div>
															     	<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Purpose
									 ...
									 <div class="form-padding-correction">
							         <textarea 	 name="purpose" class="form-control"  placeholder="Enter Name" value="" disabled ><?php echo $row['purpose']; ?></textarea>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name">Quantity
									 ...
									 <div class="form-padding-correction">
							         <input type="text"	 name="quantity" class="form-control"  placeholder="Enter Name" value="<?php echo $row['quantity']; ?>" disabled ></textarea>
								    </div>
									</div>
									
									<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Requested Date
                                    </label>
									 <div class="form-padding-correction">
							         <input type="text" 	 name="datereq" class="form-control"  placeholder="Enter Name" value="<?php echo $row['datereq']; ?>" disabled ></textarea>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name">Remarks
									 ...
									 <div class="form-padding-correction">
							         <textarea 	 name="remarks" class="form-control"  placeholder="Enter Name" value=""  ></textarea>
								    </div>
									</div>
							...
							<?php } ?>
						            ...
						            <div class="btn-addproducts">
									 <a href="reservation.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
									</div>
...
$remarks = $_POST['remarks'];
			...
			$result= mysqli_query($conn,"select * from reservation_request where remarks='$remarks'") or die (mysql_error());
			$row=mysqli_num_rows($result);
		   ...
		   $result= mysqli_query($conn,"select * from reservation_request where reservation_id='$reservation_id'") or die (mysql_error());
			...
			$cur_date = date("Y-m-d H:i:s");
						...
						$sql="update reservation_request set username='$username',iname='$iname', stats = 'Disapprove' , remarks = '$remarks' ,datedisapp='$cur_date' where reservation_id='$reservation_id'";
						mysqli_query($conn,"INSERT INTO audittrail(adminname,action,task,date)VALUES('$usernamer','Disapproved','Reservation ( $username $iname )','$cur_date')")or die(mysql_error());
						
						if ($conn->query($sql) === TRUE) { 
                   		echo "<script>alert('Reservation Rejected!'); window.location='reservation.php'</script>";
                        } else {
							echo "<script>alert('sadasdsd sadzz!'); window.location='request.php'</script>";
                        }
