                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								  ...
								  <a href="addofficial.php"><button type="button" class="btn btn-primary">Add Official </button></a>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from bofficial where bofficial_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from bofficial order by bofficial_id ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deleteofficial.php<?php echo '?bofficial_id='.$bofficial_id; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>

	 <a href="editofficial.php<?php echo '?bofficial_id='.$bofficial_id; ?>"><button type="button" class="btn btn-primary btn-sm">Edit</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
