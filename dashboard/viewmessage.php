        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
		   ...
		   ?><?php } ?><?php else:?>
					...
					<?php
							...
							?>	
					<li class="active"><a href="message.php"><i class="fa fa-envelope"></i> Message&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $count; ?></span></a>  </li> 
...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
			...
			<div id="page-wrapper">
				<div class="row">
					<div class="col-lg-12">
											<h1>Barangay Mahabang Parang <small>View Message</small></h1>
					...
					<div class="col-lg-12">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								...
								$result= mysqli_query($conn,"select * from messages where msg_id='$msg_id'") or die (mysql_error());
								...
								<div class="products-add-info">
										...
										<label class="control-label .col-lg-2" for="first-name">Name
										 ...
										 <input type="text" name="fullname" class="form-control"  placeholder="Enter Name" value="<?php echo $row['fullname']; ?>" disabled>
										</div>
										</div>
									
										
										<div class="form-padding">
										<label class="control-label .col-lg-2" for="first-name">Phone Number
										</label>
										 <div class="form-padding-correction">
										 <input type="text" name="phone" class="form-control" placeholder="Enter Information" value="<?php echo $row['phone']; ?>"disabled>
										</div>
										</div>
										
																			<div class="form-padding">
										<label class="control-label .col-lg-2" for="first-name">Message
										</label>
										 <div class="form-padding-correction">
										 <textarea type="text" name="message" class="form-control"  placeholder="Enter Person" value=""disabled><?php echo $row['message']; ?></textarea>
										</div>
							...
							<br><br>
																												...
																												<div class="form-padding">
										<label class="control-label .col-lg-2" for="first-name">Reply
										</label>
										 <div class="form-padding-correction">
										 <textarea type="text" name="reply" class="form-control"  placeholder="Enter Reply" value=""></textarea>
										</div>
								
								 
							
										<div class="btn-addproducts">
										 <a href="message.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
										</div>
	...
	$headers = "From: admin@brgymahabangparang.com";
		$mail_Subject = "Reply from Barangay Mahabang Parang Admin $usernames";
		$mail_Body = "$reply";
