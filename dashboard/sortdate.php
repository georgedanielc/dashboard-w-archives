            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
                    <li><a href="archives.php"><i class="fa fa-database"></i> Archives</a></li>
					                    <li class="active"><a href="appreq.php"><i class="fa fa-tasks"></i> Approved Requests</a></li>      
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
						  SORT BY:
								  <a href="sortdate.php"><button type="button" class="btn btn-primary">DATE </button></a>
								  								  <a href="sortmonth.php"><button type="button" class="btn btn-primary">MONTH </button></a>
																  <br><br>
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from document_request where request_id LIKE '%$txtsearch%' or cert_id LIKE '%$txtsearch%' or or clear_id LIKE '%$txtsearch%'") or die (mysql_error());
											...
											$result= mysqli_query($conn,"SELECT * FROM document_request where stats='Approve' ORDER BY DATE(dateapp)=DATE(NOW()) DESC, DATE(dateapp)<DATE(NOW()) DESC, DATE(dateapp)>DATE(NOW()) ASC	  ") or die (mysql_error());
