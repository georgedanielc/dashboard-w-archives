...
$bofficial_id=$_GET['bofficial_id'];
			...
			mysqli_query($conn,"delete from archofficial  where bofficial_id='$bofficial_id'")or die(mysql_error());;
			mysqli_query($conn,"INSERT INTO bofficial(oname,oimage,bdate,position)VALUES('$oname','$oimage','$bdate','$position')")or die(mysql_error());
			
			$sql="INSERT INTO audittrail(adminname,action,task,date)VALUES('$username','Restored','Deleted Official ( $oname )','$cur_date')";
