            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
					...
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						...
						<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						<li class="active"><a href="archincidents.php"><i class="fa fa-globe"></i> Deleted Incidents</a></li>
						<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Incident Report</a></li>

          </ol>
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted Reports</small></h1>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archincident where irfno LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archincident order by irfno ASC ") or die (mysql_error());
  ...
  <tr>
	<td><?php echo $row['irfno']; ?></td>
	<td><?php echo $row['typeofincident']; ?></td>
	...
	<td>
	 ...
	 <a href="deleteincident.php<?php echo '?irfno='.$irfno; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actincident.php<?php echo '?irfno='.$irfno; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
