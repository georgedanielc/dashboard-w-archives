                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Comments Information</h3>
                        </div>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from comments where commentno LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from comments order by commentno ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td><?php echo $row['email']; ?></td>
		<td><?php echo $row['commentto']; ?></td>
	<td><?php echo $row['comment']; ?></td>
	<td><?php echo $row['commentdate']; ?></td>

	<td>

	 <a href="archprojectss.php<?php echo '?commentno='.$commentno; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>

	<!-- <a href="reply.php<?php echo '?commentno='.$commentno; ?>"><button type="button" class="btn btn-primary btn-sm">Reply</button></a>-->
	</td>
  </tr>
  		<?php } ?>
</table>
