        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
		   ...
		   ?><?php } ?><?php else:?>
					...
					<?php
							...
							?>	
					<li class="active"> <a href="reservables.php"><i class="fa fa-globe"></i> Reservables&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="badge"><?php echo $count; ?></span></a>  </li><?php endif;?>
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
...
mysqli_query($conn,"update items set rname='$rname',itemdesc='$itemdesc',  requirements='$requirements',  quantity='$quantity',iimage='$still_profile1' where item_id='$item_id'")or die(mysql_error());
...
mysqli_query($conn,"update items set rname='$rname',itemdesc='$itemdesc',  requirements='$requirements',  quantity='$quantity',iimage='$still_profile1' image = '$profile' where item_id='$item_id'")or die(mysql_error());								
echo "<script>alert('Successfully Updated Info!'); window.location='reservables.php'</script>";										
									}
