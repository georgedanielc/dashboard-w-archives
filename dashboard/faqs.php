...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Frequently Asked Questions</small></h1>
...
<div class="button-addproducts">
								  ...
								  <a href="addfaqs.php"><button type="button" class="btn btn-primary">Add Question & Answer </button></a>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from faqs where faq_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from  faqs  order by faq_id  ASC ") or die (mysql_error());
  ...
  <tr>
  	<td width="35%"><?php echo $row['question']; ?></td>
	  	<td  width="1000000%"><?php echo $row['answer']; ?></td>


	<td>

	 <a href="archfaqss.php<?php echo '?faq_id='.$faq_id; ?><?php echo '?id_session='.$id_session; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>
