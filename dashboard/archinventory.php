    ...
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li><a href="archrequest.php"><i class="fa fa-tasks"></i> Disapproved Requests</a></li>                    
                    <li><a href="archreservation.php"><i class="fa fa-globe"></i>Disapproved Reservations</a></li>
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
                    <li class="active"><a href="archinventory.php"><i class="fa fa-globe"></i>Barangay Inventory</a></li>
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Inventory</a></li>

          </ol>
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Barangay Inventory</small></h1>
...
<table>
  <tr>
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from items where item_id LIKE '%$txtsearch%' or item_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
	else{
		
											$result= mysqli_query($conn,"select * from items") or die (mysql_error());
  ...
  <tr>
    <td><img src="reservables/<?php echo $row['image']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 ...
	 <a href="deletereservation.php<?php echo '?reservation_id='.$reservation_id; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>
	 	 <a href="resremark.php<?php echo '?reservation_id='.$reservation_id; ?>"><button type="button" class="btn btn-primary btn-sm">View Remarks</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
