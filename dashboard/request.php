                        ...
                        <div class="panel-body">
                            ...
                            <div id="shieldui-grid1">
								      <!--<div class="button-print">
									    <a href="reports/requestreport.php" target="_blank">
...
<table  id="example">
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from document_request where request_id LIKE '%$txtsearch%' or cert_id LIKE '%$txtsearch%' or or clear_id LIKE '%$txtsearch%'") or die (mysql_error());
											...
											$result= mysqli_query($conn,"select * from document_request where stats='Pending' order by datereserved DESC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deleterequest.php<?php echo '?request_id='.$request_id; ?>"><button type="button" class="btn btn-primary btn-sm">Disapprove</button></a>
	 	 <a href="docapproval.php<?php echo '?request_id='.$request_id; ?>"><button type="button" class="btn btn-primary btn-sm">Approve</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
