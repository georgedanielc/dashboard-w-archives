            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
					...
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						...
						<li class="active"><a href="archbanner.php"><i class="fa fa-globe"></i> Deleted Banners</a></li>
...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Banners</a></li>

          </ol>
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted Banners</small></h1>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archbanner where b_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archbanner order by b_id ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deletebanner.php<?php echo '?b_id='.$b_id; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actbanners.php<?php echo '?b_id='.$b_id; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
