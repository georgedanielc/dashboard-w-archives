...
mysqli_query($conn,"update document_request set username='$username',iname='$iname', datereq='$datereq' , stats = 'Approve' where request_id='$request_id'")or die(mysql_error());
echo "<script>alert('Successfully Approve!'); window.location='request.php'</script>";		
$sql="INSERT INTO audittrail(adminname,action,task,date)VALUES('$usernames','Approved','Reservation #$request_id','$cur_date')";
