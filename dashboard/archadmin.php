		   ...
		   <a class="navbar-brand" href="archives.php">Archives</a><?php } ?><?php else:?><?php endif;?>
            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
					...
					<li class="active"><a href="archadmin.php"><i class="fa fa-bullseye"></i> Deleted Admin</a></li>
											<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Admin</a></li>
                ...
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted Admin</small></h1>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archadmin where username LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archadmin order by username ASC ") or die (mysql_error());
  ...
  <tr>
    <td><img src="userimage/<?php echo $row['uimage']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 ...
	 <a href="deleteadmin.php<?php echo '?username='.$username; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actadmin.php<?php echo '?username='.$username; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
