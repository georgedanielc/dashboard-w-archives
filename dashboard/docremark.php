...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div id="page-wrapper">
                        ...
                        <div class="panel-body">
							...
							<?php } ?>
						            ...
						            <div class="btn-addproducts">
									 <a href="archrequest.php"> <button type="button" class="btn btn-primary">Cancel</button></a>
									</div>
			...
			mysqli_query($conn,"delete from document_request where request_id='$request_id'")or die(mysql_error());;

			
			$sql="INSERT INTO audittrail(adminname,action,task,date,remarks)VALUES('$usernames','Delete','Document Request from $username ($iname)','$cur_date','$remarks')";
