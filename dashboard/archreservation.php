...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Reservations</a></li>

          </ol>
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Disapproved Reservation/s</small></h1>
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from reservation_request where item_id LIKE '%$txtsearch%' or item_id LIKE '%$txtsearch%'") or die (mysql_error());
											...
											$result= mysqli_query($conn,"select * from reservation_request where stats='Disapprove' ") or die (mysql_error());
