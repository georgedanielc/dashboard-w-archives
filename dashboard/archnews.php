            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
					...
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						...
						<li class="active"><a href="archnews.php"><i class="fa fa-globe"></i> Deleted News</a></li>
...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">News And Announcements</a></li>

          </ol>
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted News</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">News Information</h3>
                        </div>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archnews where news_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archnews order by news_id ASC ") or die (mysql_error());
  ...
  <tr>
    <td><img src="news/<?php echo $row['nimage']; ?>" width="75px" height="50px"></td>
	<td><?php echo $row['nname']; ?></td>
	<td><?php echo $row['datedeleted']; ?></td>

	<td>

	 <a href="deletenews.php<?php echo '?news_id='.$news_id; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actnews.php<?php echo '?news_id='.$news_id; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
