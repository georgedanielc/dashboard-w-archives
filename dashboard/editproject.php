                        ...
                        <div class="panel-body">
							...
							<div class="picture">
							   ...
							   <a href=""><?php if($row['pimage'] != ""): ?>
										<img src="projects/<?php echo $row['pimage']; ?>" width="200px" height="150px" style="border:4px groove #CCCCCC; border-radius:5px;">
										<?php else: ?>
...
mysqli_query($conn,"INSERT INTO audittrail(adminname,action,task,date)VALUES('$username','Edited','Project $pname','$cur_date')")or die(mysql_error());
