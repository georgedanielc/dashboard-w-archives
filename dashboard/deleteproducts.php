                        ...
                        <div class="panel-body">
							...
							<div class="picture">
							   ...
							   <a href=""><?php if($row['pimage'] != ""): ?>
                                    ...
                                    <input type="file" style="height:44px; margin-top:10px;" name="image" id="last-name2" value=<?php echo $row['pimage']; ?> disabled/>
							...
							<div class="products-add-info">
									...
									<label class="control-label .col-lg-2" for="first-name">Barcode
							         ...
							         <input type="text" name="barcode" class="form-control"  placeholder="Enter Barcode" value="<?php echo $row['Barcode']; ?>" disabled>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name">Brand Name
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="brandname" class="form-control" placeholder="Enter Brand Name" value="<?php echo $row['bname']; ?>" disabled>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name" >Product Name 
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="pname" class="form-control" placeholder="Enter Product Name" value="<?php echo $row['pname']; ?>" disabled>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name" >Motor Part 
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="motorpart" class="form-control" placeholder="Enter Motor Part" value="<?php echo $row['motorpart']; ?>" disabled>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name" >Model Number 
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="modelnumber" class="form-control" placeholder="Enter Model Number" value="<?php echo $row['modelnumber']; ?>" disabled>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name" >Quantity
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="quantity" class="form-control" placeholder="Enter Quantity" value="<?php echo $row['quantity']; ?>" disabled>
								    </div>
									</div>
									...
									<label class="control-label .col-lg-2" for="first-name" >Price 
									 ...
									 <div class="form-padding-correction">
							         <input type="text" name="price" class="form-control" placeholder="Enter Price" value="<?php echo $row['price']; ?>" disabled>
								    </div>
									</div>
							...
							<?php } ?>
								 ...
								 <div class="btn-cancel">
								  <a href="delete.php<?php echo '?Barcode='.$barcode;?>"> <button type="Submit" class="btn btn-success">Delete Product</button></a>
								 </div>
