        ...
        <div id="page-wrapper">
            ...
            <div class="row">
				...
				<div class="form-padding">
									<label class="control-label .col-lg-2" for="first-name">Resident ID
                                    </label>
									 <div class="form-padding-correction">
									     <div class="search-box">
        <input type="text" autocomplete="off" name="resident_id" class="form-control" placeholder="Search Resident ID" />
        <div class="result">
		</div>
    </div>
								    </div>
...
$age = $row['age'];
			 ...
			 VALUES('$username', '$resident_id','$email', '$password','Resident')")or die(mysql_error());	
						...
						values ('$fname','$mname','$lname','$username','$passwords','$contact','$email','Resident','$rimage','$resident_id','$address','$bdate','$gender','$age')";
						if ($conn->query($sql) === TRUE) {
                   		echo "<script>alert('User successfully added!'); window.location='users.php'</script>";
                        } else {
							echo "<script>alert('Error'); window.location='adduser.php'</script>";
                        }
