  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
								$result= mysqli_query($conn,"select * from users ") or die (mysql_error());
	  ...
	  <tbody id="myTable">
    <td><a href="addusers.php<?php echo '?resident_id='.$resident_id; ?>"><img src="resident/<?php echo $row['uimage']; ?>" width="75px" height="50px"></td>
