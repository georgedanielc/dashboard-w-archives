                    ...
                    <div class="panel panel-primary">
						...
						<input id="myInput" type="text" placeholder="Search..">
                            <div id="shieldui-grid1">
								  ...
								  <a href="addresident.php"><button type="button" class="btn btn-primary">Add Resident </button></a>
								  
								  </div>
								  
								      <div class="button-print">
									    <a href="reports/resreport.php" target="_blank">
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
	  ...
	  <tbody id="myTable">
    <td><a href="addusers.php<?php echo '?resident_id='.$resident_id; ?>"><img src="resident/<?php echo $row['rimage']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 <a href="disresident.php<?php echo '?resident_id='.$resident_id; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a><?php } ?>
	 						        <?php
					        $result= mysqli_query($conn,"select * from users where resident_id = $resident_id") or die (mysql_error());
							$row=mysqli_num_rows($result);
		...
		while ($row= mysqli_fetch_array ($result) ){
			$resident_id=$row['resident_id'];
							...
							?>
	  <a href="adduser.php<?php echo '?resident_id='.$resident_id; ?>"><button type="button" class="btn btn-primary btn-sm">Add User</button></a>
	</td><?php } ?>
  </tr>
  		</tbody>
</table>
