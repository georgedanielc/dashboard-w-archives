        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">            
		   ...
		   ?><?php } ?><?php else:?>
					...
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						...
						<li class="active"><a href="banners.php"><i class="fa fa-globe"></i> Banners</a>  </li>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<form method="POST" enctype="multipart/form-data" action="">
									...
									<label class="control-label .col-lg-2" for="first-name">Banner Name
                                    </label>
...
$bname = $_POST['bname'];
			...
			mysqli_query($conn,"INSERT INTO audittrail(adminname,action,task,date)VALUES('$username','Added','Banner $bname','$cur_date')")or die(mysql_error());
                   
						$sql="insert into banner (bname, bimage,author) values ('$bname','$book_image','$username')";
