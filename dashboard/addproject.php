                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Ongoing Project Information</h3>
                        </div>
...
$date = $_POST['date'];
				...
				$username=$row['fname']." ".$row['lname'];
						...
						mysqli_query($conn,"INSERT INTO audittrail(adminname,action,task,date)VALUES('$username','Added','Project $pname','$cur_date')")or die(mysql_error());
                   
						$sql="insert into projects (pname, info, person, date, pimage,author) values ('$pname','$info', '$person', '$date', '$book_image','$username')";
