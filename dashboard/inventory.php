...
<body>
 ...
 <ul class="nav navbar-nav navbar-right navbar-user">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1>Rifa Motor Shop <small>Inventory</small></h1>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div id="shieldui-grid1">
								  ...
								  <a href="reports/preport.php" target="_blank">
								  <button type="button" class="btn btn-success">Print Products</button>
								  </a>
								  </div>
...
<table>
  ...
  <tr>
	...
	<td>
	 <a href="editproducts.php<?php echo '?Barcode='.$barcode; ?>"> <button type="button"  class="btn btn-primary btn-sm">Edit</button></a>
		 <a href="deleteproducts.php<?php echo '?Barcode='.$barcode; ?>"><button type="button" class="btn btn-primary btn-sm">Delete</button></a>
	</td>
  </tr>
  		<?php } ?>
</table>
