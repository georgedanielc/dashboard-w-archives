...
<table  id="example">
  ...
  <tr onclick='trclick();'>
	<td onclick='tdclick();'><?php echo $row['fullname']; ?></td>
	...
	<td>
	 ...
	 <a href="deletemessage.php<?php echo '?msg_id='.$msg_id; ?>"><button type="button" class="btn btn-primary btn-sm">Archive</button></a>
