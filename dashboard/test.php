  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-products'];
	  ...
	  <tbody id="myTable" >
    <td><a href="adduser.php<?php echo '?resident_id='.$resident_id; ?>"><img src="resident/<?php echo $row['rimage']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 <a href="disresident.php<?php echo '?resident_id='.$resident_id; ?>"><button type="button" class="btn btn-primary btn-sm">Disable</button></a><?php } ?>
	 						        <?php
