            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
					...
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						...
						<li class="active"><a href="archprojects.php"><i class="fa fa-globe"></i> Deleted Projects</a></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Projects</a></li>
                ...
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted Projects</small></h1>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archprojects where project_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archprojects order by project_id ASC ") or die (mysql_error());
  ...
  <tr>
	...
	<td>
	 ...
	 <a href="deleteprojects.php<?php echo '?project_id='.$project_id; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actprojects.php<?php echo '?project_id='.$project_id; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
