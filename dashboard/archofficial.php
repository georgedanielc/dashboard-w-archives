            ...
            <div class="navbar-collapse collapse templatemo-sidebar">
                <ul class="nav navbar-nav side-nav">
					...
					<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
						...
						<li class="active"><a href="archofficial.php"><i class="fa fa-globe"></i> Deleted Officials</a></li>
						<li style=" margin-left: 10px;"><p style="color:gray; cursor:context-menu;">____________________________</p></li>
...
<li><a href="../sessiondes.php"><i class="fa fa-power-off"></i> Log Out</a></li>
        ...
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li class="active">Barangay Officials</a></li>

          </ol>
                <div class="col-lg-12">
                    <h1>Barangay Mahabang Parang <small>Deleted Officials</small></h1>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Official's Information</h3>
                        </div>
...
<table>
  ...
  <?php
   if ($_SERVER["REQUEST_METHOD"] == "POST"){ 
    ...
    $txtsearch=$_POST['search-user'];
								$result= mysqli_query($conn,"select * from archofficial where bofficial_id LIKE '%$txtsearch%'") or die (mysql_error());
	
	}
else{
		
											$result= mysqli_query($conn,"select * from archofficial order by bofficial_id ASC ") or die (mysql_error());
  ...
  <tr>
    <td><img src="bofficial/<?php echo $row['oimage']; ?>" width="75px" height="50px"></td>
	...
	<td>
	 ...
	 <a href="deleteofficial.php<?php echo '?bofficial_id='.$bofficial_id; ?>"><button type="button" class="btn btn-primary btn-sm">Permanently Delete</button></a>
					...
					<a href="actofficial.php<?php echo '?bofficial_id='.$bofficial_id; ?>"><button type="button" class="btn btn-primary btn-sm">Restore</button></a>
